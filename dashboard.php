    ...
    <div class="container-fluid ps-0">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-12 text-center mt-2">
          <h5>Bonjour Monsieur <u class="text-danger"><?php echo $_SESSION['name']; ?></u></h5>
          <p class="mt-2">partager avec nous votre livre apres l'inscription et tu peut aussi exporter at faire CRUD sur votre livres ici .</p>
        </div>
      </div>
    </div>
  </main>
